...
![emojis-and-ligatures](./screenshots/emojis-and-ligatures.webp)

![neovim-ligatures](./screenshots/neovim-ligatures.webp)
...
NOTE: Use the `nix-build` shell script to do the same.
